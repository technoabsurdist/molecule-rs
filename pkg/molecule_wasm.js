 ...
 * @returns {any}
 */
export function get_3dmol_atoms(pdb_content) {
    const ptr0 = passStringToWasm0(pdb_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function get_3dmol_bonds(pdb_content) {
    const ptr0 = passStringToWasm0(pdb_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function prepare_for_3dmol(pdb_content) {
    const ptr0 = passStringToWasm0(pdb_content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('molecule_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
